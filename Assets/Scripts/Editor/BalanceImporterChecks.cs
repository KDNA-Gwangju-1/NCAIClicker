        ...
        public static void RunBatch()
        {
            ...
            try
            {
                ...
                var cases = new[]
                {
                    ...
                    new[] { "targets.csv", "normal,철광석,3,0,0.5,4.0,1,c5,c100,0,0,0,0,0.35,", "normal,철광석,3,0,0.5,4.0,1,c5,c100,0,0,0,-1,0.35," },
                    new[] { "targets.csv", "normal,철광석,3,0,0.5,4.0,1,c5,c100,0,0,0,0,0.35,", "normal,철광석,3,0,0.5,4.0,1,c5,c100,0,0,0,0,-0.35," },
                    new[] { "targets.csv", "normal,철광석,3,0,0.5,4.0,1,c5,c100,0,0,0,0,0.35,", "normal,철광석,3,0,0.5,4.0,1,c5,c100,0,0,0,50,0.35," },
                    ...
                    // 최대 액면 (#330): coins.csv 에 없는 id, 최소 액면보다 작은 상한은 거부 — 후보가 비면 0 원 크리처가 된다
                    new[] { "targets.csv", "normal,철광석,3,0,0.5,4.0,1,c5,c100,", "normal,철광석,3,0,0.5,4.0,1,c5,c999," },
                    new[] { "targets.csv", "normal,철광석,3,0,0.5,4.0,1,c5,c100,", "normal,철광석,3,0,0.5,4.0,1,c5,c1," },
