...
namespace NCAIClicker.Core
{
    ...
    public class GameManager : MonoBehaviour, IGameFlowService
    {
        ...
        ///
        /// 파산도 회차 층을 지운다 (이슈 #250) — 업그레이드·코인·단계가 되돌아가고 레거시 포인트와
        /// 반지만 남는다. 다만 그 일은 BillManager.ResetRound 가 하고, 이 메서드는 영구 층까지
        /// 포함해 전부 비운다. 설정 초기화(#196)와 함께 그 둘이 영구 층을 지우는 유일한 경로다.
        /// </summary>
