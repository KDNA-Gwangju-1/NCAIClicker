...
- [에디터 검증 하네스](validation-harness.md) — `*Checks` 를 리플렉션으로 모아 실행, 항목 선택 창, 예외 격리와 통과/실패 요약
...
- [하루 진행과 고지서](billing.md) — BillManager, 고지서 발행·조기 납부·퍼크 제시, 대출·상환·거절 사유 구분, 마감 미납 파산
