...
- `NanumSquare-OFL.txt` 는 네이버 nanum-square.zip 에 라이선스 파일이 없어 나눔고딕 OFL 전문을 복사한 것이다. 저작권 줄의 Reserved Font Name 목록에 NanumSquare 가 명시돼 있지 않다.
