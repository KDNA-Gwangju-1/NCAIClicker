# 소형 소품 7종 3D 에셋 (랜턴·곡괭이·삽·경고 표지판·나무 팻말·밧줄·양동이)

> 관련 이슈: #238 · 최종 수정: 2026-09-22
...
뽑고, `Assets/Prefabs/{Name}Visual.prefab` 으로 분리 제작했다. 로직 컴포넌트가 없는 순수 시각
에셋이며, 씬 배치(6.26)에서 그대로 배치용 프리팹으로 쓰인다 — [광물 크리처 에셋](mineral-creature-assets.md)의
...
```mermaid
flowchart LR
  subgraph Asset["소형 소품 시각 에셋 (7종)"]
    glb["{Name}.glb<br/>VARCO 3D 생성, glTFast 임포트"]
    visual["{Name}Visual.prefab<br/>root=Visual, 소품별 스케일"]
    glb --> visual
  end
```
...
|---|---|---|---|---|---|
| `LanternVisual.prefab` | `Assets/Prefabs/` | 0.52 | height | 0.5211 | 0.0000 |
| `PickaxeVisual.prefab` | `Assets/Prefabs/` | 0.68 | depth (눕혀짐) | 0.6775 | 0.0000 |
| `ShovelVisual.prefab` | `Assets/Prefabs/` | 0.68 | height | 0.6956 | 0.0000 |
| `WarningSignVisual.prefab` | `Assets/Prefabs/` | 1.20 (크리처 1.5배) | height | 1.2013 | 0.0000 |
| `SignboardVisual.prefab` | `Assets/Prefabs/` | 0.72 | height | 0.7175 | 0.0000 |
| `RopeCoilVisual.prefab` | `Assets/Prefabs/` | 0.48 | width (지름, 눕혀짐) | 0.5077 | 0.0000 |
| `BucketVisual.prefab` | `Assets/Prefabs/` | 0.56 | height | 0.5614 | 0.2811 |
