...
> 관련 이슈: #46, #43 · 최종 수정: 2026-09-17

## 무엇을 하는가

Windows PC용 기본 해상도·창 모드·리사이즈·전체화면 전환과 Enter Play Mode 설정을 저장소 기준으로 고정한다. URP 렌더 파이프라인 에셋과 품질 레벨은 PC 하나만 둔다 (`Assets/Settings/PC_RPAsset` / `PC_Renderer`, Mobile 은 #79 에서 삭제).
...
- 폰트 파일은 8.1(#42) 에서 배치한다. 아이콘은 임시 플랫 일러스트(망치에 맞는 돼지)다 — VARCO 망치 렌더가 나오면 `Assets/Materials/AppIcon.png` 를 같은 이름으로 교체하면 된다 (#66).
...
| 2026-09-16 | #66 | Claude | 임시 앱 아이콘 배치, Default Icon 적용 |
| 2026-09-17 | #79 | Claude | Mobile URP 에셋·품질 레벨 삭제 |
